...
import { getVoiceDisplayName } from "@/lib/constants";
...
const VapiControls = ({ book }: { book: IBook }) => {
  ...
  const getStatusDisplay = () => {
    switch (status) {
      ...
      case "starting":
        return { label: "جارٍ البدء...", color: "vapi-status-dot-starting" };
      case "listening":
        return { label: "يستمع", color: "vapi-status-dot-listening" };
      case "thinking":
        return { label: "يفكر...", color: "vapi-status-dot-thinking" };
      case "speaking":
        return { label: "يتحدث", color: "vapi-status-dot-speaking" };
      default:
        return { label: "جاهز", color: "vapi-status-dot-ready" };
    }
  };
          ...
          <div className="vapi-cover-wrapper">
            ...
            <div className="vapi-mic-wrapper relative">
              ...
              <button
                ...
                aria-label={
                  isActive ? "إيقاف المساعد الصوتي" : "تشغيل المساعد الصوتي"
                }
                title={
                  isActive ? "إيقاف المساعد الصوتي" : "تشغيل المساعد الصوتي"
                }
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="vapi-status-indicator">
                <span className="vapi-status-text">
                  الصوت: {getVoiceDisplayName(book.persona)}
                </span>
              </div>
